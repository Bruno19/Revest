    ...
    <script type="text/javascript" src="galeria/js/jssor.js"></script>
    <script type="text/javascript" src="galeria/js/jssor.slider.js"></script>
    <script>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r {
                ...
                height: 40px;
                cursor: pointer;
                background: url(galeria/img/a17.png) no-repeat;
                overflow: hidden;
            }
            ...
            */
            ...
            .jssort01 {
                ...
                .jssort01 .c {
                    ...
                    background: url(galeria/img/t01.png) -800px -800px no-repeat;
                    _background: none;
                }
