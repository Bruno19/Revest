<script type="text/javascript" src="js/cadastrar-mapping.js"></script>
<section class="Centro Conteudo">
	...
	<form name="cadclipping" method="post" onsubmit="return CadastrarClipping(this)">	
		...
		<div class="Linha">				
			<input type="text" name="title" class="Campo input" placeholder="Nome: " style="width: 37.3%"/>						
		</div>
		<div class="Linha">				
			<select name="uf" class="Campo input" onchange="CapturarEstado(this.value)">
				<option value="null">--Selecione a UF</option>
				<?php 
					$uf = array(
		...
		<div class="Linha">				
			<input type="text" name="info" class="Campo input" placeholder="Informação: " style="width: 37.3%"/>						
		</div>	
		
		<div class="Linha">				
			<input type="text" name="cont1" class="Campo input" placeholder="E-mail / Contato 1: " style="width: 37.3%"/>						
		</div>
		
		<div class="Linha">				
			<input type="text" name="cont2" class="Campo input" placeholder="Website / Contato 2: " style="width: 37.3%"/>						
		</div>	
