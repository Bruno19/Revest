...
<html lang="pt-br">
	...
	<body>
		...
		<div class="Centro FundoConteudo">
			...
			<?php
				$SelectAllNews = mysqli_query($conn, "SELECT id_c FROM clipping WHERE type_c=2");
				...
				$SelectClipping = mysqli_query($conn, "SELECT * FROM clipping WHERE type_c=2 ORDER BY id_c DESC LIMIT $Limite, $NoticiasPorPagina");
